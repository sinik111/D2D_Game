...
void TempEnemyAttack::OnTriggerStay(const Collision& collision)
{
...
EnemyBase* TempEnemyAttack::GetEnemyBase() const
{
	return m_parentEnemy;
}

void TempEnemyAttack::SetAttackState(AttackState state)
{
	m_attackState = state;
}


void TempEnemyAttack::SetDirection(const Vector2& direction)
{
