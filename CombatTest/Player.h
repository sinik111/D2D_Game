...
public:
	...
	void PlayerNormalAttack1(float duration);
	...
	void PlayerNormalAttackAll (float duration);

	void PlayerHeavyAttack(float duration);
	...
	float m_attackNormalDuration = 0.84f;
	float m_attackNormalOnceDuration = 0.67f;
	float m_attackNormalTwiceDuration = 0.51f;
	float m_attackNormalThreeTimesDuration = 0.43f;
	
	float m_attackHeavyDuration = 1.0f;
	float m_attackHeavyTwiceDuration = 1.6f;
	
	float m_attackNormalAllDuration = 1.584f;
