...
public :
	...
	Structure(std::wstring filepath) :jsonfilepath(filepath){}
	...
	std::wstring GetJsonFilePath() { return jsonfilepath; }
	//void SetJsonFilePath(std::string filepath) { jsonfilepath = filepath; }
	void SetJsonFilePath(std::wstring filepath) { jsonfilepath = filepath; }
	void ImportfromJson();
