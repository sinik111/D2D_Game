...
{
	Debug::Log(L"EnemyZako OnTriggerExit");
}
...
void EnemyZako::AnimationInit()
{
	...
	m_animator->AddActionOnEvent(L"Enemy_Atteck001", this, &EnemyZako::EnemyAttack);
...
void EnemyZako::InitAnimPath(AnimPathArray& animPath, const std::wstring& animName)
{
	if (animName == L"NormalEnemyHorizontalAttack1")
	{

		std::wstring spriteSheetPath = L"NormalEnemy\\NormalEnemyHorizontalAttack1\\NormalEnemyHorizontalAttack1_sprites.json";
		...
		for (size_t i = 0; i < animPath.size(); ++i)
		{
			...
			std::wstring animationClipPath = L"NormalEnemy\\" + animName + L"\\" + baseFileName + L"_anim.json";
			m_animator->AddAnimationClip(animationClipPath);
		}
	}
	else if (animName == L"NormalEnemyHorizontalAttack2")
	{

		std::wstring spriteSheetPath = L"NormalEnemy\\NormalEnemyHorizontalAttack2\\NormalEnemyHorizontalAttack2_sprites.json";
		m_animator->AddSpriteSheet(spriteSheetPath);
	...
	else
	{
		for (size_t i = 0; i < animPath.size(); ++i)
		{
			...
			std::wstring spriteSheetPath = L"NormalEnemy\\" + animName + L"\\" + baseFileName + L"_sprites.json";
			m_animator->AddSpriteSheet(spriteSheetPath);
